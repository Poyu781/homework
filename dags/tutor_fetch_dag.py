try:
    ...
    print(6)
    from snapask_crawl.crawl_tutors_by_api import do_multiple_thread_to_store_data,fetch_tutors_data,insert_tutors_info_mysql,get_elite_tutors
...
def get_tutors_from_snapask(**context):
    result = do_multiple_thread_to_store_data(fetch_tutors_data,15)
